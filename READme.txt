...
Struggling and piecing all the things there is for a normal coding intro class , I spent much time honing in on the exact code I would need, and what it
 even did exactly.
...
3. Others in other fields can contribute respectively to their knowledge on a particular knowledge base , 
for a particular knowledge or skill set, 
- No body knows it all ! , However as a Web-Developer , we should be able to easily partake in the creation
and implementation of a library for whatever specific path or skillset need be, in order to facilitate easy , clear , accurate , and quick referencing.

We could grow the codebase , and basically use the site as our own knowledge base repo.
...
Site details :   vampeyer.github.io/indexch.html

Please respond to this email 
jthompsonofficial0376@gmail.com , 
and let me know if , or how i can transfer this repo for someone at code louisville to host it , 
that way people can access it and use it. 
...
--- I NEED CODE LOUISVILLE TO TAKE THIS SITE FROM ME AND HOST IT PLEASE!!!!  - - - -if it seems like  a good idea - - - 
you guys talk it over and tell me what you think.

- github only allows one hosting site and this is more or less temporary until we can find a home for a code house / knowledge base repo.





- index file is named indexch.html , and is not the default hosting site of index.html as it should be. 
				- to remedy this issue without breaking links , a main page may be created in the future
					called index.html just as a pre- landing page , but it works fine now. 
...
p.s.    Permanent requested donation bargain request price to teach new students FOREVER , (just $109.95)   
(-  Includes 3 months of support. )


This took me a whole lot of time to do myself , 
It will certainly be MUCH more easy and much more accessable after the students can have a clear view of the site.

Please consider donating at - jthompsonofficial0376@gmail.com     or at this address, 

i cannot afford a 250$ tax ID# , so , please consider small donations here
0x373911a7e00b8be900Ed4B46255f9019275B7F3d

This was a lot of links.

ty

/
- REGARDLESS , ownership rights   default  to Code Louisville in 3 months from now  on 08/24/2022
...
keep on making updates again, and 
